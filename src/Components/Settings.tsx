...
const [data, setData] = useState<{
    ...
    const [LinkedIN_,setLinkedIn] = useState<string>(data.LinkedIN);
    const [YouTube_,setYouTube] = useState<string>(data.YouTube);
    const [Facebook_,SetFacebook] = useState<string>(data.FaceBook);
    const [Instagram_,SetInstagram] = useState<string>(data.Instagram);
    const [X_,SetX] = useState<string>(data.X);
    const [Github_,SetGithub] = useState<string>(data.GitHub);
...
const removeSkill = (skillToRemove: string) => {
    ...
    useEffect(()=>{
        console.log(Github_ !== data.GitHub,Github_,data.GitHub)
    },[Github_])

    const [lod_btn,setLd_btn] = useState<boolean>(false);
    const updatePersonalInfo = () => {
        if (aboutMe !== data.About || personalMail !== data.MailAddress ||
            resume_link !== data.Resume || LinkedIN_ !== data.LinkedIN ||
            YouTube_ !== data.YouTube || Github_ !== data.GitHub ||
            Instagram_ !== data.Instagram || X_ !== data.X ||
            Facebook_ !== data.FaceBook ){
                setLd_btn(true);
            axios.post(url + '/update_personal_data', {
                RollNumber: RollUMN,
                About: aboutMe || null,
                CodeChefUsername: data.CodeChefUsername || null, //  can remove
                Department: data.Department, 
                Facebook: Facebook_ || null,
                GeekForGeeksUsername: data.GeekForGeeksUsername || null, // can remover
                Github: Github_ || null,
                HackerRankUsername: data.HackerRankUsername || null, // can remove
                Instagram: Instagram_ || null,
                LeetCodeUsername: data.LeetCodeUsername || null, // can remove
                LinkedIn: LinkedIN_ || null,
                MailAddress: personalMail || null,
                Name: data.Name,
                Resume: resume_link || null,
                X:X_ || null,
                Youtube : YouTube_ || null
            })
            .then((response) => {
    ...
    }, [aboutMe, personalMail, resume_link, data ,
        lc_username , hrc_username , cc_username , gfg_username,
        LinkedIN_ , YouTube_ , Github_ , Instagram_ , Facebook_ , X_]);
                        ...
                        items-start justify-start ">
                            ...
                            <div className=" flex justify-center flex-col items-center gap-6 mt-2 max-sm:mt-0">
                                <div className=" flex items-center gap-4">
                                    <a className="text-gray-700 hover:text-orange-600" aria-label="Visit LinkedIn" href={data.LinkedIN}
                                        target="_blank">
                                    ...
                                    <input type="text" value={LinkedIN_}
                                    onChange={(e)=>{
                                        setLinkedIn(e.target.value);
                                    }}
                                     className="  w-fit border min-w-[600px] max-sm:min-w-[50vw] px-2 py-1 text-sky-500 rounded-md" />
                                </div>
                                <div className=" flex items-center gap-4">
                                    <a className="text-gray-700 hover:text-orange-600" aria-label="Visit YouTube" href={data.YouTube}
                                        target="_blank">
                                    ...
                                    <input type="text" value={YouTube_}
                                    onChange={(e)=>{
                                ...
                                <div className=" flex items-center gap-4">
                                    <a className="text-gray-700 hover:text-orange-600" aria-label="Visit Facebook" href={data.FaceBook}
                                        target="_blank">
                                    ...
                                    <input type="text" value={Facebook_}
                                    onChange={(e)=>{
                                ...
                                <div className=" flex items-center gap-4">
                                    <a className="text-gray-700 hover:text-orange-600" aria-label="Visit Instagram" href={data.Instagram}
                                        target="_blank">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="h-6">
                                            <path fill="currentColor"
                                    ...
                                    <input type="text" value={Instagram_}
                                    onChange={(e)=>{
                                ...
                                <div className=" flex items-center gap-4">
                                    <a className="text-gray-700 hover:text-orange-600" aria-label="Visit Twitter" href={data.X}
                                        target="_blank">
                                ...
                                <div className=" flex items-center gap-4">
                                    <a className="text-gray-700 hover:text-orange-600" aria-label="Visit GitHub"
                                    href={data.GitHub}
                                        target="_blank">
                                        <Git_hub/>
                                    </a>
                                    <input type="text" value={Github_}
                                    onChange={(e)=>{
